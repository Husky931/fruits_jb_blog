    ...
    return (
        <section>
            ...
            <ol className="flex flex-col gap-y-5 mt-2">
                ...
                <li>
                    <strong>Almond's Exclusive Home: </strong>California is the
                ...
                <li>
                    ...
                    also the country's leading agricultural state in terms of
            ...
            <br />
            <p>
                The United States of America, the melting pot of nations all
                over the world, spans across 50 states and showcases a vast
                variety of landscapes ranging from vast plains, mountains,
                forests, and coastal regions. This geographical diversity
                contributes to its agricultural prowess.
            </p>
            <br />
            <div>
                <p>
            ...
            <div>
                ...
                <p>
                    ...
                    field labor and fruit picking to managerial roles and
